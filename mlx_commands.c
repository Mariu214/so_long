...
void    go_up(t_data *data)
{
    ...
    if (data->tab[data->pos.height - 1][data->pos.width] == 'C')
    {
        data->acquired++;
        put_img_to_img(&data->img, &data->background, data->pos.width * 60, 
            data->pos.height * 60);
    ...
    if (data->tab[data->pos.height - 1][data->pos.width] == 'E')
    {
        if (data->acquired == data->objective)
        {
            put_img_to_img(&data->img, &data->background, data->pos.width * 60, 
                data->pos.height * 60);
            data->pos.height--;
...
void    go_left(t_data *data)
{
    ...
    if (data->tab[data->pos.height][data->pos.width - 1] == 'C')
    {
        data->acquired++;
        put_img_to_img(&data->img, &data->background, data->pos.width * 60, 
            data->pos.height * 60);
